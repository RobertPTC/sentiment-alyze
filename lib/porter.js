module.exports = (function() {
  ...
  return function(w) {
    ...
    re = /^(.+?)eed$/;
    //this particular expression leaves one wanting;
    //'string', for instance, is parsed weirdly into sr;
    re2 = /^(.+?)(ed|ing)$/;
    ...
    if (re.test(w)) {
      ...
      var fp = re2.exec(w);
      stem = fp[1];
      //hack to replace words that end with double consonants
      //before ing, e.g. shopping, flapping
